<div id='about'class="about-us impaire">
    ...
    <div class="messages">
        ...
        <div class="message-body">
            ...
            <div class="message-right">
                <p class="conversation-right">What is Micro Club? 🤔</p>
            </div>
            <div class="message-left">
                <p class="conversation-left special-border">Micro Club is the first founded scientific club in Algeria, back in March 5th, 1985.</p>
            </div>
            <div class="message-left">
                <p class="conversation-left">We focuse on Computer Science and IT field as we work to popularize among the student community.
                </p>
            </div>
            <div class="message-right">
                <p class="conversation-right">What do you actually do? 🤔</p>
            </div>
            <div class="message-left">
                <p class="conversation-left special-border">From hackathons to cybersecurity competitions, indie video game development industry, open-source technology and knowledge sharing, as a university scientific club and student organization we've got a wide spectrum of activities and topics covered up at Micro Club - USTHB.</p>
            </div>
            <div class="message-left">
                <p class="conversation-left">Our type of activities are training, workshops, organizing events, talks and competitions...
                    These activities are setup by the club members themselves. As students, it is important to learn a variety of skills other than technical ones. It is also the best way to work in a team and grow both as a person and as a member of society.
                </p>
            </div>
            <div class="message-right">
                <p class="conversation-right">Mmm that seems intrestring could you show us some pictures 😊 😊 ?</p>
            </div>
            <div class="message-left">
                <img class="conversation-img" src="./SVG/MICRO-MCTF.jpg" alt="">  
            </div>
            <div class="message-right">
                <p class="conversation-right">Hmmm Nice ! </p>
            </div>
            <div class="message-left">
            ...
            <div class="message-left">
                <p class="conversation-left">You're Welcome don't forget to Join us !
                </p>
            </div>
        </div>
    </div>
