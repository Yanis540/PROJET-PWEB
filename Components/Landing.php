<div id="landing-page" class="landing-page paire">

      <div class="landing-left">
            <div class="landing-logo">
                  <svg class="landing-logo-img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 362.44 190.01">
            ...
            <div class="landing-desc">
                  ...
                  <h2 class="landing-desc-title">We're a scientific club located in USTHB, ready to help students get started in the Tech field.</h2>
            </div>
      ...
      <div class="landing-right">
            <div class="landing-images">
                  ...
                  <svg class="hacker" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <div class="landing-guid">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="39" viewBox="0 0 22 39">
                        <g id="Group_69" ><g id="Rectangle_20" class="cls-1"><rect class="cls-3" width="22" height="39" rx="11"/><rect class="cls-4" x="1.5" y="1.5" width="19" height="36" rx="9.5"/></g><rect id="Rectangle_21" class="cls-2" width="4" height="11" rx="2" transform="translate(9 8)"/></g>
                        </svg>
                  </div>
                  <h3 >Scroll down</h3>
            </div>
...
<!-- <svg  class="dash" height="175px" version="1.1">
      <path fill="transparent" stroke="var(--background-color)" stroke-width="4" d="M10 80 Q 77.5 10, 145 80 T 280 80" class="path"></path>
</svg> -->